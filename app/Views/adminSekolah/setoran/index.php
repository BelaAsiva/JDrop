...
<div class="container">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="mb-0">🛢️ Daftar Setoran Jelantah</h3>
    <a href="<?= base_url('admin-sekolah/setoran/create') ?>" class="btn btn-success">
      + Tambah Setoran
    </a>
  </div>
        ...
        <tbody>
          <?php foreach ($setoran as $i => $s): ?>
            <tr>
              ...
              <td class="text-center"><?= number_format($s['volume_ml']) ?></td>
              <td class="text-center"><?= $s['poin_didapat'] ?></td>
              <td class="text-center">
                <a href="<?= base_url('admin-sekolah/setoran/edit/' . $s['id']) ?>" class="btn btn-sm btn-warning me-2">
                  <i class="bi bi-pencil"></i> Edit
                </a>
                <a href="<?= base_url('admin-sekolah/setoran/delete/' . $s['id']) ?>" class="btn btn-sm btn-danger"
